		...
		<nav class="navbar navbar-inverse">
  			<div class="container-fluid">
    			<div class="navbar-header">
      				<a class="navbar-brand" style="color:white" href="index.php">Case Management System</a>
    			</div>
    			...
    			<div class="collapse navbar-collapse" id="myNavbar">
      				...
      				<ul class="nav navbar-nav navbar-right">
						<?php if($loginstatus == 'loginok') {?>
							<li><a href="updateuser2.php?id=<?php echo $login_id ?>" class="glyphicon glyphicon-user" style="color:LawnGreen"><?php echo " " . $loginname . " (" . $type . ")"; ?></a></li>
